# An evaluator for numbers and arithmetic call expressions.
"""
...
Operator expressions must be operator symbols. Operand expressions are separated by
spaces.
Examples:
    > (* 1 2 3)
    6
...
"""
from helper import trace, main, interact
