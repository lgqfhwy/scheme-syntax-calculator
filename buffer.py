# Utility classes for reading multi-line input
...
class Buffer(object):
    ...
    def pop(self):
        ...
        exhausted its source, return None."""
    ...
    def __str__(self):
        """ Return recently read contents; current elements marked with >>. """
        # Foramt string for right-justified line numbers
        n = len(self.lines)
